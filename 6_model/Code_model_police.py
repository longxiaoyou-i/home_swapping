    ...
    for j in ll:
        ...
        for h in dic_home:
            ...
            if len(dic_work[j]) == 1:  
                ...
                if dis_worker == 0:
                        dis_worker = 1
                A = capacity * (1 + capacity_select) / dis_worker
            ...
            if len(dic_work[j]) == 3:
                ...
                if dis_worker3 == 0:
                    dis_worker3 = 1
                A = capacity * (1 + capacity_select) / pow((dis_worker1  * dis_worker2  * dis_worker3),
                                                           1 / 3)
                E = 1 - abs(origin_price - change_price) / origin_price
            ...
            if len(dic_work[j]) == 4:
                ...
                if dis_worker4 == 0:
                    dis_worker4 = 1
                A = capacity * (1 + capacity_select) / pow((dis_worker1 * dis_worker2 * dis_worker3 * dis_worker4),
                                                           1 / 4)
                E = 1 - abs(origin_price - change_price) / origin_price
                if h in dic_home_three_four:
                    if E > 0 and dic_home_three_four[h] > 0:
            ...
            for h in dic_home:
                ...
                if len(dic_work[j]) == 3:
                    ...
                    A = capacity * (1 + capacity_select) / pow(
                        (dis_worker1  * dis_worker2 * dis_worker3), 1 / 3)
                    E =1 - abs(origin_price - change_price) / origin_price
                    if h in dic_home_three_four:
                        if E > 0 and dic_home_three_four[h] > 0:
                            P = A * E * police
                ...
                if len(dic_work[j]) == 4:
                    ...
                    if dis_worker4 == 0:
                        dis_worker4 = 1
                    A = capacity * (1 + capacity_select) / pow(
                            (dis_worker1 * dis_worker2 * dis_worker3 * dis_worker4), 1 / 4)
                    E = 1 - abs(origin_price - change_price) / origin_price
                    if h in dic_home_three_four:
                        if E > 0 and dic_home_three_four[h] > 0:
                            P = A * E * police
