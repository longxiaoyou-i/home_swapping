...
def swap_home(dic_id_home_workplace,pid,dic_dis,dic_home_price,dic_poi_can_change):
    cen_lon = 114.510292; cen_lat = 38.042557  
    m=0
    n=0
    sc_dis=0  
...
if __name__ == '__main__':
    ...
    dic_id_home_workplace1 = swap_home(dic_id_home_workplace,pid,dic_dis,dic_home_price,dic_poi_can_change) 
    
    file = open('D:/main_code/3_constrained_home_swapping/SDGHS/SDGHS_12.txt', 'w')
