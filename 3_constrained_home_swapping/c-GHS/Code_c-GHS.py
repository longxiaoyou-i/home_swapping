# -*- coding: utf-8 -*-
"""
Created on Wed Jul  5 15:14:14 2023
@author: Czhao_Team
"""
...
def swap_home(dic_id_home_workplace,pid,dic_dis):
    cen_lon = 114.510292; cen_lat = 38.042557  #Latitude and longitude of the city center
    m=0  
    n=0
    sc_dis=0  
...
if __name__ == '__main__':
    ...
    f_point_center = open('D:/main_code/1_navigation_routin_crawer/sample_origin-point_same-street-point_street-center-point_street-id.txt.txt', 'r', encoding='utf-8-sig')
    ...
    file = open('D:/main_code/3_constrained_home_swapping/c-GHS/c-GHS_12.txt', 'w')
